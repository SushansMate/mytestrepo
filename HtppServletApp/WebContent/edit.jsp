							...
							<div class="row register-form">
								<div class="col-md-4">
									<div class="form-group">
										<input type="hidden" name="page" value="PersonUpdatePage" /> <input
											type="hidden" name="id"
											value="<%=request.getParameter("id")%>" /> <input
											type="text" class="form-control" placeholder="Full Name *"
											name="fname" value="<%=request.getParameter("name")%>" />
									</div>
									<div class="form-group">
										<input type="text" class="form-control"
											placeholder="Person Age *" name="age"
									...
									<div class="form-group">
										<div class="maxl">
											<label class="radio inline"> <input type="radio"
												...
												<%=request.getParameter("gender").equals("male") ? "checked" : ""%>>
												<span> Male </span>
											</label> <label class="radio inline"> <input type="radio"
												name="gender" value="female"
												<%=request.getParameter("gender").equals("female") ? "checked" : ""%>>
												<span>Female </span>
											</label>
										</div>
									</div>
									<div>
										<a href="index.jsp"></a><input type="button"
											class="btnRegister" value="HOME" /></a> <input type="submit"
											class="btnRegister" value="UPDATE" />
									</div>
